...
namespace HDTest.Data.Migrations
{
    ...
    [Migration("20220626162404_addSavedStatustoOCR_RequestModel")]
    partial class addSavedStatustoOCR_RequestModel
    {
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.BANG_DIEM", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 26, 23, 24, 3, 841, DateTimeKind.Local).AddTicks(6588));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.BANG_DIEM_TIENG_ANH", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 23, 24, 3, 834, DateTimeKind.Local).AddTicks(7437));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.CCCD", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 23, 24, 3, 844, DateTimeKind.Local).AddTicks(3426));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.Document", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 23, 24, 3, 780, DateTimeKind.Local).AddTicks(5653));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.GIAY_CAM_KET_TRA_NO", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 23, 24, 3, 831, DateTimeKind.Local).AddTicks(2367));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.GIAY_XAC_NHAN_TOEIC", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 23, 24, 3, 817, DateTimeKind.Local).AddTicks(9294));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.GIAY_XAC_NHAN_VAY_VON", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 23, 24, 3, 838, DateTimeKind.Local).AddTicks(5860));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.OCR_Request", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 23, 24, 3, 812, DateTimeKind.Local).AddTicks(5956));
