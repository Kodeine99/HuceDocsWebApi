...
namespace HDTest.Data.Migrations
{
    ...
    [Migration("20220625190059_AddSomeDocModel")]
    partial class AddSomeDocModel
    {
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.BANG_DIEM", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        ...
                        .HasDefaultValue(new DateTime(2022, 6, 26, 2, 0, 58, 946, DateTimeKind.Local).AddTicks(8033));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.BANG_DIEM_TIENG_ANH", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 2, 0, 58, 939, DateTimeKind.Local).AddTicks(3908));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.CCCD", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 2, 0, 58, 949, DateTimeKind.Local).AddTicks(5662));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.Document", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 2, 0, 58, 897, DateTimeKind.Local).AddTicks(9285));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.GIAY_CAM_KET_TRA_NO", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 2, 0, 58, 935, DateTimeKind.Local).AddTicks(1788));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.GIAY_XAC_NHAN_TOEIC", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 2, 0, 58, 931, DateTimeKind.Local).AddTicks(1882));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.GIAY_XAC_NHAN_VAY_VON", b =>
                {
                    ...
                    b.Property<DateTime>("CREATE_DATE")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 2, 0, 58, 943, DateTimeKind.Local).AddTicks(7114));
            ...
            modelBuilder.Entity("HuceDocs.Data.Models.OCR_Request", b =>
                {
                    ...
                    b.Property<DateTime>("CreateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 6, 26, 2, 0, 58, 927, DateTimeKind.Local).AddTicks(4422));
